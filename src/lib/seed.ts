...
export const seedDatabase = (): Database => {
  ...
  const properties = [
    ...
    },
    {
      ...
      listingType: "rent" as const,
      categoryId: "cat_luxury",
      tagIds: ["tag_featured", "tag_waterfront"],
      lat: 33.3301,
      lng: -96.7902,
      bedrooms: 3,
      bathrooms: 3,
  ...
  return {
    ...
    tags: [
      ...
      },
      {
        ...
        name: "Featured",
        color: "#1e3a5f",
        description: "Highlight on homepage and marketing.",
        createdAt: now,
        updatedAt: now,
      },
      {
      ...
      },
      {
        ...
        name: "New listing",
        color: "#0f766e",
        description: "Listed within the last 30 days.",
        createdAt: now,
        updatedAt: now,
      },
    ],
